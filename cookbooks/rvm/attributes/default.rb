...
default['rvm']['user_default_ruby'] = "ruby-1.9.3-p448"
...
when "redhat","centos","fedora","scientific","amazon"
  node.set['rvm']['install_pkgs']   = %w{sed grep tar gzip bzip2 bash git}
  default['rvm']['user_home_root']  = '/home'
when "debian","ubuntu","suse"
  node.set['rvm']['install_pkgs']   = %w{sed grep tar gzip bzip2 bash git-core}
  default['rvm']['user_home_root']  = '/home'
